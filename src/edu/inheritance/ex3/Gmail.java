...
public class Gmail extends GoogleService{
    ...
    // 매개변수 생성자 GoogleService 에 존재하는 필드 값만 사용하는 생성자
    // GoogleService에서 serviceName 은 Gmail 이기 때문에
    ...
    @Override
    public void search(){
        System.out.println("Gmail 에서 메일을 검색합니다.");
    }
    @Override
    public void share(){
        System.out.println("Gmail 에서 메일을 전달합니다.");
    }
