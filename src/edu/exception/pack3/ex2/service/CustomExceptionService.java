...
public class CustomExceptionService {
    ...
    public void problem2() {
        ...
        try {
            ...
            if  (password.length() < 6) {
                throw new TooShortPasswordException("비밀번호 6자 이상 작성해야 합니다.");
            }
    ...
    public void problem3() {
        ...
        try {
            ...
            if  (score < 0 || score > 100) {
                throw new InvalidScoreException("점수는 0~100 사이의 정수를 입력해야 합니다..");
            }
    ...
    public void problem5() {
        ...
        try {
            ...
            if (itemCount > 10) {
                throw new TooManyItemsException("장바구니가 가득 찼습니다.");
            }
