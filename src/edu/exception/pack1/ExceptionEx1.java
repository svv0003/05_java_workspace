...
catch 구문은 무한대로 작성 가능하다.
catch () {}에서 소괄호 () 내에 특정 예외 상황 발생하는 타입을 작성하고,
중괄호 내에 예외 상황에 대해 대처하도록 개발자가 기능을 작성한다.
...
언제 사용하는가?
자바 프로그램과 외부 프로그램의 장치 연결을 끊고,
끊음에 대한 출력을 사용할 때 주로 사용한다.
"기능을 종료합니다."와 같은 문구를 출력하도록 한다.
 */
