...
public class Exercise1 {
    ...
    public void method2(String dirName, String fileName){
        ...
        try {
            ...
            System.out.println("파일 읽기 중 오류 발생했습니다.");
        }
    }
    ...
    public void method3(String dirName, String fileName){
        ...
        try {
            ...
            System.out.println("회사에서 지시한 규칙대로 추후 필요한 조치를 취해야 한다.");
        }
    }
    ...
    public void method4(){
        ...
        try {
            ...
            if (Files.exists(filePath)) {
                ...
                System.out.println("temp.txt 파일이 삭제되었습니다.");
                System.out.println("파일 삭제 결과 확인 : " + Files.exists(filePath));
            }
        } catch (IOException e) {
    ...
    public void method5(String folder1, String folder2, String folder3){

        // 폴더 구조만 생성
        Path dirPath = Path.of(folder1, folder2, folder3);
        try {
            Files.createDirectories(dirPath);

            //
            Path note1Path = Path.of(folder1, folder2, folder3, "note1.txt");
            Path note2Path = Path.of(folder1, folder2, folder3,"note2.txt");
            ...
            System.out.println("note1 파일 내용 : " + note1Read);
            System.out.println("note2 파일 내용 : " + note2Read);
        } catch (IOException e) {
            System.out.println("파일 처리 중 오류 발생");
        }
