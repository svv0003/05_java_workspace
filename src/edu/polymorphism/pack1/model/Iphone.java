...
public class Iphone extends SmartPhone {
    ...
    // 객체를 생성할 때 아무런 데이터도 설정하지 않은 상태에서 공간을 생성한다.
    public Iphone() {
    }

    // 객체를 생성할 때 iosVersion 데이터를 전달받은 후 공간을 생성한다.
    public Iphone(int iosVersion) {
        this.iosVersion = iosVersion;
    }

    // 객체를 생성할 때 SmartPhone 데이터를 전달받은 후 공간을 생성한다.
    public Iphone(String display, String newsAgency, String ap) {
        super(display, newsAgency, ap);
    }

    // 객체를 생성할 때 iosVersion + SmartPhone 데이터를 전달받은 후 공간을 생성한다.
    ...
    public String toString() {
        // iosVersion + SmartPhone에 작성된 toString 정보를 사용한다.
