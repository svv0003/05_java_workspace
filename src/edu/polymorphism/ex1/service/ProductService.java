...
public class ProductService {
    ...
    // 필드
    Electronics phone = new Electronics("삼성 갤럭시", "PHONE001", 800000, 10,
            "최신 스마트폰", "삼성", 0.2,  "15W",24);

    Clothing tshirt = new Clothing("면 티셔츠", "SHIRT001", 25000, 50,
            "100% 면 소재", "무신사", 0.3, "L", "화이트", "면");

    Food apple = new Food("사과", "APPLE001", 5000, 100,
